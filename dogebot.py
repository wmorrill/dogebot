...
class BinanceBot:
	def __init__(self, api_key, api_secret):
		...
		self.coins_of_interest = ['TRX', 'XRP', 'ICX', 'BNB', 'LEND', 'ADA', 'APPC',  'XLM', 'EOS']
	...
	def cancel_order(self, sym):
		result = self.client.cancel_order(order[0], order[1])
		return result
